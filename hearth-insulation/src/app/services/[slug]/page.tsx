...
export async function generateMetadata({
  ...
  return {
    ...
    description: `${service.teaser} Free thermal imaging evaluation and fixed-price quote. Serving the Indianapolis metro since 2004.`,
    alternates: { canonical: `/services/${service.slug}/` },
    openGraph: {
      title: `${service.name} | Hearth Insulation`,
    ...
    <>
      ...
      <div className="page-hero">
        ...
        <div className="container" style={{ paddingTop: "1.6rem" }}>
          <span className="eyebrow">Indianapolis Metro</span>
          <h1>{service.name}</h1>
        ...
        <div className="container two-col">
          ...
          <div>
            ...
            <p className="form-note">
              Noticing any of these? The evaluation that confirms it is free
              and comes with thermal images you keep.
            </p>
          </div>
        </div>
      </section>
